# MTConnect System Startup Script - Working Version
# Based on original smart-fanuc-monitor.ps1
...
try {
    $mongo = docker exec mtconnect-mongodb mongosh mtconnect --eval 'db.machine_data.countDocuments()' --quiet
