...
Write-Host "MTConnect System Launcher v1.0" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "NOTICE: You can safely close this window!" -ForegroundColor Yellow
Write-Host "All processes are running independently in background." -ForegroundColor Yellow
Write-Host ""
