                ...
                if (parsedAgentXml.MTConnectStreams && parsedAgentXml.MTConnectStreams.Streams && parsedAgentXml.MTConnectStreams.Streams.DeviceStream) {
                    ...
                    try {
                        ...
                        if (pathComponentStream?.Events) {
                            ...
                            let originalProgramValue = null;
                            let originalProgramTimestamp = null;
                            ...
                            if (DEBUG_DETAILS)
                                console.log(`machinedetails 📝 Обновлен Program для ${machine.name} (${machine.id}): ${finalProgramDisplayValue} в ${finalProgramDisplayTimestamp}`);
                        }
                    }
                    catch (e) {
